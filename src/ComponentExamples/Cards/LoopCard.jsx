...
const LoopCard = () => {
  ...
  return (
    <div className="cardImg relative w-[230px] h-[230px] sm:w-[350px] sm:h-[300px] rounded-2xl overflow-hidden shadow-lg">
      ...
      <AnimatePresence mode="wait">
        <motion.div className="relative z-10 p-4 text-white bg-[#23282944] border border-[#343434] h-full flex flex-col items-start gap-2 justify-center backdrop-blur-sm rounded-2xl overflow-hidden">
          <AnimatePresence mode="wait">
            <motion.div
              key={currentIndex}
              initial={{ opacity: 0 }}
