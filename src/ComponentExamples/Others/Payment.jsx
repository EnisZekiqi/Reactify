...
const Payment = () => {
  ...
  return (
    <div
      className={`${addCash ? "bg-white w-[260px] sm:w-fit rounded-3xl transition-all duration-500" : "bg-transparent"}`}
    >
      <div
        className={`${addCash ? "bg-transparent" : "bg-white"} flex items-center  gap-10 justify-around text-black p-2 rounded-full`}
      >
