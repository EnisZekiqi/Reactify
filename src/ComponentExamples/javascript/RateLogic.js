...
type RateState = "notClicked" | "Clicked" | "Hovering";

const RateButton: React.FC = () => {
  const [rateMe, setRateMe] = useState<RateState>("notClicked");
  const [animateStar, setAnimateStar] = useState<boolean>(false);
  const [count, setCount] = useState<number>(38);
