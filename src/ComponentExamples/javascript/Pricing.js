...
export const codeSnippet28TS = `
import { motion, AnimatePresence } from "framer-motion";
import { useState } from "react";
import { IoMdCheckmark } from "react-icons/io";

type PricingType = "Monthly" | "Annual";
...
const cards: CardData[] = [
  {
    ...
    ability: ["Basic Analytics", "Email Support", "Access to community"],
  },
  {
    title: "Professional",
    description: "Advanced features for pros.",
    price: { Monthly: 29, Annual: 290 },
    ability: ["Priority Support", "Advanced Analytics", "All Starter features"],
  },
  {
    title: "Enterprise",
    description: "Custom solutions for large teams.",
    price: { Monthly: 99, Annual: 999 },
    ability: ["Dedicated Account Manager", "Custom Integrations", "All Pro features"],
  },
];

const Pricing: React.FC = () => {
  const [statePricing, setStatePricing] = useState<PricingType>("Monthly");
              ...
              <div className="text-3xl font-semibold mb-4 h-10 overflow-hidden relative">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute"
                    style={{
                      color: prp.title === "Professional" ? "#00d8ff" : "#fff",
                    }}
                  >
                    $ {priceToShow}
                    <span
