      ...
      {TABS.map((tab) => (
        ...
        >
          <div
            ...
            } rounded-2xl p-2 flex items-center gap-1 transition-all duration-300} // Add '' in className
          >
            {tab.id}
            <motion.div
  ...
  },
  {
    ...
    content: (
      <div className="flex items-center justify-around gap-4">
        <div className="f border-r border-[#00d8ff] pr-5 flex flex-col gap-2 items-center text-sm font-medium text-[#9faaac] hover:text-[#fbfbfb] transition-all duration-200">
          <FiHome size={24} />
          <p>Home</p>
        </div>
        <div className="f border-r border-[#00d8ff] pr-5 flex flex-col gap-2 items-center text-sm font-medium text-[#9faaac] hover:text-[#fbfbfb] transition-all duration-200">
        ...
        <div className="f pr-0 flex flex-col gap-2 items-center text-sm font-medium text-[#9faaac] hover:text-[#fbfbfb] transition-all duration-200">
          <FiBarChart2 size={24} />
          <p>Chart2</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col gap-1 items-start">
          ...
          <p className="text-start text-xs">
            ...
            velit hic accusamus vel doloribus optio sit eos eius sequi,
            assumenda totam commodi unde ipsa voluptatem sint repellat
            consectetur, officiis aspernatur! Culpa doloremque,
          </p>
        </div>
        <div className="flex flex-col gap-1 items-start">
          <h2>Text2</h2>
          <p className="text-start text-xs">
            ...
            molestias suscipit repellat doloremque quam. Deserunt quas neque
            excepturi minus harum tempora delectus est adipisci, itaque hic
            ipsam eius repudiandae porro.
          </p>
        </div>
      </div>
    ),
