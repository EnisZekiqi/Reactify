...
const Payment = () => {
  ...
  return (
    <div
      className={
        addCash
          ? "bg-white w-[260px] sm:w-fit rounded-3xl transition-all duration-500"
          : "bg-transparent"
      }
    >
      <div
        className={
          addCash ? "bg-transparent" : "bg-white"
        } 
        className="flex items-center gap-10 justify-around text-black p-2 rounded-full"
      >
        ...
        <motion.div
          ...
          className="bg-black text-white rounded-full text-xs sm:text-lg w-22 sm:w-fit p-3 cursor-pointer z-50"
        >
          Add Cash
        </motion.div>
        ...
        {addCash && (
          <motion.div
            ...
            className="text-black rounded-full p-0 sm:p-3 cursor-pointer"
          >
      ...
      {addCash && (
        <div className="flex flex-col text-black z-[500]">
          <span className="text-sm sm:text-md font-semibold pl-2 mt-2">
            Payment Mode
          </span>
...
const Payment: React.FC = () => {
  ...
  const [choosePayment, setChoosePayment] = useState<string>("");

  const paymentMethods: string[] = ["card1", "card2"];
  ...
  return (
    ...
    >
      <div
        className={{
          addCash ? "bg-transparent" : "bg-white"
        } flex items-center gap-10 justify-around text-black p-2 rounded-full}
      >
        <div className="flex items-center gap-2">
          <CiWallet size={23} />
          <div className="flex flex-col items-start">
