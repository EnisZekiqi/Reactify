...
const Docs = () => {
  ...
  const chooseLibrary = (libraryName) => {
    const selectedLibrary = Libraries.find(
      (lib) => lib.library.toLowerCase() === libraryName.toLowerCase(),
    );
  ...
  const Libraries = [
    {
      ...
      second:
        "Why choose Vite ? , is fast it uses HMR for fast updated thru the DOM it works smoothly with React and it is used in this project!",
    },
    {
      ...
      second:
        "The newest update of the framer motion is changed to just motion , install both if you see any errors on the component since it is a lightweight library",
    ...
    },
    {
      ...
      caution:
        "Please restart the editor then reRun the project for the tailwind to work",
      ...
      <div className="relative flex flex-col items-center justify-center mt-24 sm:mt-10 z-[90]">
        <div className="flex flex-col items-center mt-[5%]">
          ...
          <motion.img
            ...
            className="absolute inset-0 mask-b-from-20% mask-b-to-80% w-[100%]  -mt-24 sm:-mt-28  h-screen object-cover pointer-events-none select-none z-0  blur-none"
          />
        ...
        <div className="flex w-full justify-center">
          <motion.p className="read-the-docs text-center text-sm md:text-md lg:text-lg w-full md:w-[55%] mt-5 flex flex-wrap justify-center"></motion.p>
        </div>
        <motion.div
          initial={{
            opacity: 0,
          ...
          {libraries && (
            ...
            >
              <div className="w-full">
                ...
                <p className="text-[rgba(255,255,255,0.5)] mt-8">
                ...
                {libraries.second2 && (
                  <p className="text-[rgba(255,255,255)] font-medium text-md mt-8 -mb-3 w-[300px]">
                    {libraries.second2}
                  </p>
                )}
                {libraries.config && (
                ...
                {libraries.second && (
                  <p className="mt-6 text-[rgba(255,255,255,0.5)]">
                    {libraries.second}
                  </p>
                )}
                ...
                {libraries.allo && (
                  <p className="text-white font-medium mt-8 -mb-3">
                    {libraries.allo}
                  </p>
                )}
                {libraries.importss && (
                ...
                {libraries.caution && (
                  <p className="text-[4gba(255,255,255,0.5)] mt-8">
                    {libraries.caution}!
                  </p>
                )}
              </div>
