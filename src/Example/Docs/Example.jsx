      ...
      <div className="flex items-start gap-10">
        <div className="flex flex-col gap-8">
          <div className="componentList overflow-y-hidden lg:overflow-y-auto h-full w-[200px]">
            <h1 className="text-md lg:text-xl text-white font-bold lg:font-semibold">
              Text Animations
            </h1>
          ...
          <div className="componentList overflow-y-hidden lg:overflow-y-auto h-full w-[200px] ">
            ...
            <h1 className="text-md lg:text-md text-white font-medium lg:font-semibold mt-4">
              Buttons
            </h1>
            <div className="mt-8 flex flex-col gap-5">
              {examples
        ...
        <div className="flex flex-col items-start w-[800px] lg:w-screen  -ml-[15.5%] sm:ml-[0%] justify-center">
          ...
          <div
            className="relative flex w-fit items-center justify-between gap-1 sm:gap-2 rounded-full mt-10 mb-4 p-1 md:p-2 border border-[#3b4345]"
          ...
          {seeCode === "preview" ? (
            ...
            <div
              className="w-[315px] sm:w-[500px] md:w-[850px] overflow-x-auto
                   "
            >
              {/* USAGE CONTAINER */}
              ...
              {SelectedInstalation && (
                <div className="flex flex-col">
                  <p className="text-2xl sm:text-3xl font-semibold text-white mb-2 mt-12">
                    Installation
                  </p>
              ...
              <div className="flex flex-col">
                <p className="text-2xl sm:text-3xl font-semibold text-white mb-2 mt-4">
                  Usage
                </p>
