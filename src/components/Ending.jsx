      ...
      <div className="relative flex flex-col items-center justify-center mt-10 z-[90]">
        <div className="flex flex-col items-center justify-center mt-[15%] h-full">
          ...
          <motion.img
            ...
            className="absolute mask-t-from-10% inset-0 -mt-40 sm:-mt-0 w-[100%] h-screen object-contain pointer-events-none select-none z-0  blur-md"
          />
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            className="mt-4 md:px-6 md:py-3  sm:px-4 sm:py-2 px-2 py-2 w-fit bg-[#00d8ff] hover:bg-[#00adcc] text-black rounded-lg shadow font-medium"
            whileHover={{
              scale: 1.05,
            }}
            whileTap={{
          ...
          >
            ...
            <a
              href="https://eniszekiqidev.netlify.app/"
              target="_blank"
              className="text-[rgba(255,255,255,0.5)] hover:underline transition duration-300"
            >
              Enis Zekiqi
            </a>
          </motion.p>
