...
const Ending = () => {
    return ( 
        <div className="app-bg2 h-full mb-10">
    <div className="relative flex flex-col items-center justify-center mt-10 z-[90]">
      ...
      <motion.h1 initial={{
        ...
        transition: {
          ...
          }} className="relative font-medium text-2xl md:text-3xl lg:text-5xl text-white w-full md:w-2/3  z-[10] text-center px-6 py-3">
        Delight the web with Reactify
              ...
              viewport={{once:true}}
                className="mt-4 md:px-6 md:py-3  sm:px-4 sm:py-2 px-2 py-2 w-fit bg-[#00d8ff] hover:bg-[#00adcc] text-black rounded-lg shadow font-medium" whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
