  ...
  const items = [
    {
      title: "Framer Motion",
      bgImage:
        "https://framerusercontent.com/images/PW7TZzsRuEq5sLfu3FYVeD6Kcg.png",
      text: "Framer Motion or now called Motion is an animation library that is simple to start and fun to master ",
    },
    {
      title: "React",
      bgImage:
        "https://media.licdn.com/dms/image/v2/D5612AQHK3Cr_P9REJw/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1708847734586?e=2147483647&v=beta&t=FCYsysCNzjm85_2l02-lh5PltEu34kZN1R2CH_hplto",
      text: "React 19 is used in this Library which means it has new hooks on the components and better optimization",
    },
    {
      title: "TailwindCSS",
      bgImage:
        "https://miro.medium.com/v2/resize:fit:1400/1*Q0uAcG_S2J2gkcUaF5PyxA.png",
    ...
    example1: [
      {
        Name: "Simple Text",
        description:
          "Showing letter by letter into the screen with smooth transition",
      },
    ],
    example2: [
      {
        Name: "Blur Text",
        description:
          "Showing word by word into the screen using Y and blury text in the start with transition on the screen",
      },
    ],
    example3: [
      {
        Name: "Slick Menu",
        description:
          "Showing a list with intro animation exiting animation and reshowing the menu button again with smooth transition",
      },
    ],
    example4: [
      {
        Name: "Mask Modal",
        description:
          "Showing a modal when by default has a mask in the image and then a layer on the !important image",
      },
    ],
  };
  ...
  return (
    <div className="h-[100%]">
      ...
      >
        ...
        >
          <div
            onClick={() => chooseExample("example1")}
            className="i text-end w-full pr-2 pt-2 flex items-end justify-end cursor-pointer"
          >
        ...
        >
          <div
            onClick={() => chooseExample("example2")}
            className="i text-end w-full pr-2 pt-2 flex items-end justify-end cursor-pointer"
          >
            <CiCircleQuestion className="w-[25px] h-[25px]" />
          </div>
        ...
        >
          <div>
            <div
              onClick={() => chooseExample("example3")}
              className="i text-end w-full pr-2 pt-2 flex items-end justify-end cursor-pointer"
            >
              <CiCircleQuestion className="w-[25px] h-[25px]" />
            </div>
        ...
        >
          <div
            onClick={() => chooseExample("example4")}
            className="i text-end w-full pr-2 pt-2 flex items-end justify-end cursor-pointer"
          >
            <CiCircleQuestion className="w-[25px] h-[25px]" />
          </div>
                  ...
                  <>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm opacity-90">{activeIndex.text}</p>
                      </div>
      ...
      >
        <Link to="/example/simple-text" className="flex items-center">
          {" "}
          <p className="mr-1 hover:mr-2 transition-all duration-300 flex items-center">
      ...
      <AnimatePresence>
        {showModal && (
          <motion.div
            ...
            className="fixed inset-0 pointer-events-auto z-[500] bg-[rgba(0,0,0,0.5)] bg-opacity-70 flex items-center justify-center"
          >
            <div
              onClick={(e) => e.stopPropagation()}
              className="bg-[#121212] border border-[#3b4345] text-white p-6 rounded-lg max-w-[90%] md:w-[600px] overflow-auto max-h-[70vh] relative"
            >
              <button
