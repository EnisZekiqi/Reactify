...
const [DrawerComponent,setDrawerComponent]=useState(false)
  ...
  show: {
    opacity: 1,
    transition: {
      delay: 0.5, // wait for Reactify to finish
...
{!DrawerComponent &&  <button onClick={() => setOpenSearch(true)} className="bg-transparent  border border-[#343434] lg:border-none rounded-xl p-2 cursor-pointer text-[rgba(255,255,255,0.7)] hover:text-white transition-all duration-300"><CiSearch className="w-[20px] h-[20px]" /></button>}
      ...
      <>
        ...
        >
          ...
          <div
            ...
            style={{
              borderBottom: searchFunction ? "1px solid rgba(255,255,255,0.5)" : "",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[rgba(255,255,255,0.5)] text-xs sm:text-sm">
                      {item.for}
                    </span>
                  </Link>
                </motion.div>
  ...
  {/* Separate AnimatePresence for DrawerComponent */}
  <AnimatePresence mode="wait">
    {DrawerComponent && (
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <h1 className="text-lg text-white font-bold lg:font-semibold ml-2 mb-4 mt-[20%]">
          Animated Text
            ...
            <Link
              ...
              style={{
                opacity: example.id === exampleId ? '1' : '0.7',
                borderLeft: example.id === exampleId ? '1px solid rgba(255,255,255,1)' : '1px solid rgba(255,255,255,0.4)'
              }}
            >
              {example.drawerLabel}
            </Link>
