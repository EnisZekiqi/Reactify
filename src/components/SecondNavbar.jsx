  ...
  show: {
   ...
   <div className="navbar2 flex justify-between fixed w-screen px-1 sm:px-4 ">
                 ...
                 <div className="flex flex-row-reverse items-center gap-4 text-sm font-normal mt-4">
                    <a className="githubExample opacity-70 hover:opacity-100 bg-[#00d8ff] px-3.5 py-1.5 font-medium rounded-md text-black transition-all duration-300" href="https://github.com/EnisZekiqi" target="_blank">GitHub</a>
